...
namespace murrty.controls {
    ...
    internal class ExtendedProgressBar : ProgressBar {
        ...
        private SizeF TextSize = new(0,0);
        ...
        public new ProgressBarStyle Style {
            ...
            set {
                ...
                if (value != ProgressBarStyle.Marquee) {
                    SendMessage(Handle, PBM_SETSTATE, (IntPtr)_State, IntPtr.Zero);
                }
        ...
        private void DrawText() {
            ...
            TextSize = graphics.MeasureString(base.Text, _TextFont);
            graphics.DrawString(
    ...
    internal static class TaskbarInterface {
        ...
        internal interface ITaskbarList3 {
            ...
            void ThumbBarAddButtons(IntPtr hwnd, UInt32 cButtons, [MarshalAs(UnmanagedType.LPArray)] THUMBBUTTON[] pButtons);
            void ThumbBarUpdateButtons(IntPtr hwnd, UInt32 cButtons, [MarshalAs(UnmanagedType.LPArray)] THUMBBUTTON[] pButtons);
        ...
        public static void SetProgressValue(IntPtr hWnd, UInt64 Value, UInt64 Maximum) =>
